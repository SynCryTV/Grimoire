...
local EN = {
    ...
    ["Klicken zum Öffnen/Schließen"] = "Click to open/close",
    ["Grimoire-Icons hervorheben"] = "Highlight Grimoire icons",
    ["Zeigt eine pulsierende Leuchtumrandung um die Grimoire-Buttons im Charakterfenster und Handelsfenster."] = "Shows a pulsing glow around the Grimoire buttons in the Character and Auction House windows.",
    ["Wowhead"] = "Wowhead",
    ["Murlok"] = "Murlok",
