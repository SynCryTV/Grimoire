...
GrimoireGearData["DRUID"] = {
  ["balance"] = {
    ...
    trinkets = {
      ...
      { itemId = 250215, tier = "A", contexts = { "delves", "dungeon", "raid" } },
    ...
    bisGear = {
      { label = "Overall", slots = {
        ...
        { slot = "Hands", item = { itemId = 268234, name = "Ruthless Slaughtergrips", bonusIDs = {  } }, source = "Sszorak", sourceMeta = { url = "https://www.wowhead.com/guide/midnight/raids/venomous-abyss-sszorak-boss-strategy-abilities" } },
