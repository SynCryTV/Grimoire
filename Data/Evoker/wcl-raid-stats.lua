...
GrimoireStatTargets["EVOKER"]["devastation"]["Raid"] = { targets = { crit = 1071, haste = 575, mastery = 583, versatility = 80 }, samples = 100, source = "Warcraft Logs Heroisch-Endboss", limited = true }
