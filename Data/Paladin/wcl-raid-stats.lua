...
GrimoireStatTargets["PALADIN"]["retribution"]["Raid"] = { targets = { crit = 858, haste = 629, mastery = 1007, versatility = 18 }, samples = 100, source = "Warcraft Logs Heroisch-Endboss", limited = true }
