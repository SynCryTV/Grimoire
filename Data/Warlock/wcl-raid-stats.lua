...
GrimoireStatTargets["WARLOCK"]["affliction"]["Raid"] = { targets = { crit = 846, haste = 939, mastery = 440, versatility = 36 }, samples = 100, source = "Warcraft Logs Heroisch-Endboss", limited = true }
